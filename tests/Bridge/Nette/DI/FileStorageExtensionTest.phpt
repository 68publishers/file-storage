...
final class FileStorageExtensionTest extends TestCase
{
	public function testExceptionShouldBeThrownIfNoStorageRegistered(): void
	{
		Assert::exception(
			...
			"Failed assertion 'At least one storage must be defined.' for item 'file_storage' with value object SixtyEightPublishers\FileStorage\Bridge\Nette\DI\Config\FileStorageConfig."
		);
	}
